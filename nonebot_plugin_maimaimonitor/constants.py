...
REPORT_MAPPING = {
    "1": (ReportCode.ERR_NET_LOST, "机台断网"),
    "断网": (ReportCode.ERR_NET_LOST, "机台断网"),
    "机台断网": (ReportCode.ERR_NET_LOST, "机台断网"),

    "2": (ReportCode.ERR_LOGIN, "机台无法登录"),
    "无法登录": (ReportCode.ERR_LOGIN, "机台无法登录"),
    "变游客": (ReportCode.ERR_LOGIN, "机台无法登录"),

    "3": (ReportCode.ERR_MAI_NET, "舞萌NET打不开"),
    "net打不开": (ReportCode.ERR_MAI_NET, "舞萌NET打不开"),

    "4": (ReportCode.ERR_QR, "无法获取二维码"),
    "无法获取二维码": (ReportCode.ERR_QR, "无法获取二维码"),

    "5": (ReportCode.ERR_SCORE, "成绩上传失败"),
    "成绩上传失败": (ReportCode.ERR_SCORE, "成绩上传失败"),

    "6": (ReportCode.ACC_BAN, "进小黑屋"),
    "小黑屋": (ReportCode.ACC_BAN, "进小黑屋"),
    "进小黑屋": (ReportCode.ACC_BAN, "进小黑屋"),

    "7": (ReportCode.WAIT_TIME, "排队时长"),
    "罚站时长": (ReportCode.WAIT_TIME, "排队时长"),
    "罚站": (ReportCode.WAIT_TIME, "排队时长"),
}
